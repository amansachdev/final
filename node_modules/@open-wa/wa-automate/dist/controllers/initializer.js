        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 30:
                    ...
                    _d.label = 31;
                case 31:
                    if (!!(config === null || config === void 0 ? void 0 : config.skipPatches)) return [3, 36];
                    spinner.info('Installing patches');
                    if (!!axios) return [3, 33];
                    return [4, Promise.resolve().then(function () { return __importStar(require('axios')); })];
                case 32:
                    axios = _d.sent();
                    _d.label = 33;
                case 33: return [4, axios.get(pkg.patches)];
                case 34:
                    data = (_d.sent()).data;
                ...
                case 35:
                    ...
                    _d.label = 36;
                case 36:
                    if (!((config === null || config === void 0 ? void 0 : config.skipBrokenMethodsCheck) !== true)) return [3, 38];
