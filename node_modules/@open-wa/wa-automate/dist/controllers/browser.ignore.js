...
function initClient(sessionId, config, customUserAgent) {
    return __awaiter(this, void 0, void 0, function () {
        var waPage, cacheEnabled, blockCrashLogs, sessionjsonpath, sessionjson, sd, s;
        var _this = this;
                                ...
                                case 1:
                                    ...
                                    interceptedRequest.respond({
                                        ...
                                        body: data
                                            ...
                                            .replace("RESEND_ICON:!1", "RESEND_ICON:!0")
                                            .replace("WORKER_BROKER:!1", "WORKER_BROKER:!0")
                                            .replace("LOCAL_FTS:!1", "LOCAL_FTS:!0")
                                            .replace("PRODUCT_CATALOG_ATTACHMENT:!1", "PRODUCT_CATALOG_ATTACHMENT:!0")
                                            .replace("MD_HISTORY_SYNC:!1", "MD_HISTORY_SYNC:!0")
                                            .replace("MD_PAYMENT:!1", "MD_PAYMENT:!0")
                                            .replace("MD_ADV:!1", "MD_ADV:!0")
                                            .replace("VOIP_WINDOWS:!1", "VOIP_WINDOWS:!0")
                                            .replace("MD_OFFD:!1", "MD_OFFD:!0")
                                            .replace("LICENSES_PAGE:!1", "LICENSES_PAGE:!0")
                                            .replace("MEDIA_EDITOR:!1", "MEDIA_EDITOR:!0")
                                            .replace("DEBUG_COMMANDS:A", "DEBUG_COMMANDS:!0")
                                            .replace("DOODLER:!A", "DOODLER:!0")
                                            ...
                                            .replace("DESKTOP_VOIP_VOICE_CALL:!O", "DESKTOP_VOIP_VOICE_CALL:!0")
                                            .replace("DESKTOP_VOIP_VIDEO_CALL:A", "DESKTOP_VOIP_VOICE_CALL:!0")
                                            .replace("DESKTOP_VOIP_GROUP_VOICE_CALL:A", "DESKTOP_VOIP_GROUP_VOICE_CALL:!0")
                                            .replace("DESKTOP_VOIP_GROUP_VIDEO_CALL:!1", "DESKTOP_VOIP_GROUP_VIDEO_CALL:!0")
                                            .replace("VOIP_VOICE_CALL:!O", "VOIP_VOICE_CALL:!0")
                                            .replace("MEDIAS_COUNT:!O", "MEDIAS_COUNT:!0")
                                            .replace("MEDIA_EDITOR:!1", "MEDIA_EDITOR:!0")
                                            .replace("STATUS_V3_UI_SENDING:!1", "STATUS_V3_UI_SENDING:!0")
